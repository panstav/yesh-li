	...
	return <>
		...
		<Modal {...newPageModal} render={() => <>
			...
			<div className='is-size-6 has-text-start mt-4 mb-5'>
				...
				<p className='mt-3'>שימו לב: בתצוגה המקדימה - חלקים בעמוד שלך (כמו כפתורים ושדות מסויימים) יהיו בלתי פעילים. בתצוגה למבקרים - כל אלה יפעלו בהתאם לאחר שתוציאו את העמוד האור.</p>
			</div>
