...
import { Title, SaveButton } from "@wrappers/Modal";
...
export default function SlugChoice ({ formState }) {
	...
	const buttonClassName = formState.isSubmitting ? 'is-loading' : '';
	...
	return <>
		...
		/>
		<SaveButton className={buttonClassName}>{slugT.submit_label}</SaveButton>
	</>;
}